...
export default {
    ...
    data: () => ({
        ...
        keyboardControlPad: null as Keyboard | null,
        keyboardArrows: null as Keyboard | null,
        keyboardNumPad: null as Keyboard | null,
        keyboardNumPadEnd: null as Keyboard | null,
    }),
    mounted() {
